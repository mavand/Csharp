...
namespace Another.DataSet1TableAdapters {
    ...
    public partial class MemberTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Member] WHERE (([SocialSecurity] = @Original_SocialSecurity))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Member] ([SocialSecurity], [Name], [City], [Street], [ZipCode], [Ema" +
                "il], [Phone]) VALUES (@SocialSecurity, @Name, @City, @Street, @ZipCode, @Email, " +
                "@Phone)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Member] SET [SocialSecurity] = @SocialSecurity, [Name] = @Name, [City] = " +
                "@City, [Street] = @Street, [ZipCode] = @ZipCode, [Email] = @Email, [Phone] = @Ph" +
                "one WHERE (([SocialSecurity] = @Original_SocialSecurity))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT SocialSecurity, Name, City, Street, ZipCode, Email, Phone\r\nFROM Member";
        ...
        public virtual DataSet1.MemberDataTable GetMembers() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
        ...
        public virtual int Delete(string Original_SocialSecurity) {
        ...
        public virtual int Update(string SocialSecurity, string Name, string City, string Street, string ZipCode, string Email, string Phone, string Original_SocialSecurity) {
            if ((SocialSecurity == null)) {
                throw new global::System.ArgumentNullException("SocialSecurity");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string City, string Street, string ZipCode, string Email, string Phone, string Original_SocialSecurity) {
            return this.Update(Original_SocialSecurity, Name, City, Street, ZipCode, Email, Phone, Original_SocialSecurity);
        }
    }
